...
const PresetConfig defaultBanks[10][10] = {
    ...
    // BANK 1: CLASSIC (8kHz Bytebeat)
    {
        ...
        {"t*[0,1,1.2,4/3,3/2,8/5,16/9,2]['1100330033330044550033003300305044002200220044005500330033003030110033003333004455003300330033557777666650504040550033003333005577007700660055004444223322002020606060605050404055003300333333'[t>>9]]*6", 8000, MODE_BYTEBEAT},
